...
_G.packer_plugins = {
  ...
  ["nerdtree-git-plugin"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/nerdtree-git-plugin",
  ...
  ["vim-nerdtree-syntax-highlight"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/vim-nerdtree-syntax-highlight",
